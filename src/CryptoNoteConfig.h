...
namespace parameters {
  ...
  const char     CRYPTONOTE_BLOCKS_FILENAME[]                  = "sauc-blocks.dat";
  const char     CRYPTONOTE_BLOCKINDEXES_FILENAME[]            = "sauc-blockindexes.dat";
  const char     CRYPTONOTE_BLOCKSCACHE_FILENAME[]             = "sauc-blockscache.dat";
  const char     CRYPTONOTE_POOLDATA_FILENAME[]                = "sauc-poolstate.bin";
  const char     P2P_NET_DATA_FILENAME[]                       = "sauc-p2pstate.bin";
  const char     CRYPTONOTE_BLOCKCHAIN_INDICES_FILENAME[]      = "sauc-blockchainindices.dat";
  const char     MINER_CONFIG_FILE_NAME[]                      = "sauc-miner_conf.json";
  } // parameters
...
const char     CRYPTONOTE_NAME[]                             = "SAUCoin";
const char     GENESIS_COINBASE_TX_HEX[]                     = "010a01ff0001904e029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd0880712101c196cd15e413db9fe1e39a4bcac21127f69a78471499afaa056a685dc129cd36";
